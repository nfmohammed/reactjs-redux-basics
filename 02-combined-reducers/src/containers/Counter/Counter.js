...
class Counter extends Component {
    ...
    render () {
        return (
            ...
            <hr></hr>
            <button onClick={() => this.props.onStoredResults(this.props.ctr)}>Store Results</button>
            <ul>
...
const mapStateToProps = state => {
    return {
        // state values coming from combinedReducer object. See index.js
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onStoredResults: (result) => dispatch({type: 'STORE_RESULT', result: result}), 
